...
public final class ConfigManager extends YamlConfiguration {
    ...
    public ConfigManager(Plugin plugin, String fileName, String fileExtension,
                         File folder) {
        this.folder = folder;
        this.plugin = plugin;
    ...
    private void createFile() {
        try {
            ...
            if (file.exists()) {
                ...
                RestoreData.restoreData(fileStatus);
                return;
            }
    ...
    public void reload() {
        ...
        try {
            load(file);
            ReloadData.reloadData(fileStatus);
